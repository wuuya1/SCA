...
from mamp.policies.rvo3dPolicy import RVO3DPolicy
...
def build_agents():
    ...
    for i in range(drone_num):
        agents.append(Agent(start_pos=pos[i], goal_pos=goal[i],
                            ...
                            pref_speed=pref_speed, policy=RVO3DPolicy,
                            id=i, dt=DT))
    return agents
...
if __name__ == "__main__":
    ...
    log_save_dir = os.path.dirname(os.path.realpath(__file__)) + '/../visualization/rvo3d/log/'
