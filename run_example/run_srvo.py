...
from mamp.policies.srvo3dPolicy import SRVO3DPolicy
from mamp.configs.config import DT
from mamp.envs.mampenv import MACAEnv
from mamp.util import mod2pi, l3norm
...
def build_agents():
    ...
    for i in range(drone_num):
        agents.append(Agent(start_pos=pos[i], goal_pos=goal[i],
                            ...
                            pref_speed=pref_speed, policy=SRVO3DPolicy,
                            id=i, dt=DT))
    return agents
...
if __name__ == "__main__":
    ...
    log_save_dir = os.path.dirname(os.path.realpath(__file__)) + '/../visualization/srvo3d/log/'
